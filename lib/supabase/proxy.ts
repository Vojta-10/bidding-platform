...
export async function updateSession(request: NextRequest) {
  ...
  // 1. Define exactly which routes require the user to be logged in
  const protectedRoutes = ['/dashboard', '/auctions/new'];
  ...
  if (!user && isProtectedRoute) {
    // They are trying to access a protected page without an account!
